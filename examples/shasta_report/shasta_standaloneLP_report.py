# -*- coding: utf-8 -*-
"""
Shasta-only ResTemp simulation using R3TAM package, with LP-blending
...
config_fp = './shasta_standalone_LPblend_report.yaml' #<-- if working directory not set, change this to full system filepath
